#ifndef RMD_HARDWARE_INTERFACE__EPOLL_EVENT_LOOP_HPP_
#define RMD_HARDWARE_INTERFACE__EPOLL_EVENT_LOOP_HPP_
...
#endif  // RMD_HARDWARE_INTERFACE__EPOLL_EVENT_LOOP_HPP_
